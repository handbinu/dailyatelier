...
CREATE TABLE art (
    ...
    active_point_hold_id BIGINT NULL,
...
CREATE TABLE orders (
    ...
    refund_request_status VARCHAR(30) NULL,
    refund_request_reason VARCHAR(200) NULL,
    refund_requested_at DATETIME(6) NULL,
    refund_rejected_at DATETIME(6) NULL,
